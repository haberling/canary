...
Raw material for a blog post, not the blog post itself. Chronological, quote-heavy, and honest about the parts that went sideways before they went right. Assembled 2026-08-18 from git history (both `canary` and its parent project `consolandWebsite`), `PLAN.md`, `MostImportantControversy.md`, and the actual development conversation; kept current through 2026-08-21.
