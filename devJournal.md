...
- **The dogfood site is not a demo.** It's a real, accumulating, live proof — every render mode, every widget, both hooks, all still there, all still working, because leaving them in and rebuilding them is cheaper than pretending they were never real in the first place.
